...
const offices = [
  {
    ...
    mapEmbed:
      "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3650.4!2d90.4!3d23.79!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjPCsDQ3JzI0LjAiTiA5MMKwMjQnMDAuMCJF!5e0!3m2!1sen!2sbd!4v1",
  },
  {
    city: "Chittagong",
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="bg-blue-800 dark:bg-blue-900 text-white py-20 px-4 text-center">
        ...
        <p className="text-blue-100 text-lg max-w-xl mx-auto">
          Have a question about a listing, want to list your property, or need
          help with your account? Reach out — we respond within a few hours.
        </p>
      </section>
              ...
              >
                ...
                {!o.mapEmbed && (
                  <div className="h-32 bg-blue-50 dark:bg-blue-900/20 flex items-center justify-center">
                    <MapPin
                      size={32}
                      className="text-blue-800 dark:text-blue-400 opacity-40"
                    />
                  </div>
                )}
                <div className="p-5 space-y-2">
                  ...
                  <div className="flex items-start gap-2 text-sm text-gray-600 dark:text-gray-300">
                    <MapPin
                      size={14}
                      className="text-blue-800 dark:text-blue-400 mt-0.5 shrink-0"
                    />{" "}
                    {o.address}
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
                    <Phone
                      size={14}
                      className="text-blue-800 dark:text-blue-400 shrink-0"
                    />{" "}
                    {o.phone}
                  </div>
                  <div className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-300">
            ...
            {faqs.map((faq, i) => (
              ...
              >
                ...
                >
                  ...
                  <span
                    className={`text-blue-800 dark:text-blue-400 shrink-0 text-lg font-light transition-transform ${openFaq === i ? "rotate-45" : ""}`}
                  >
                    +
                  </span>
                </button>
