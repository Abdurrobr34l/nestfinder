...
const mockUsers: MockUser[] = [
  { id: "u1", name: "Rahim Uddin", email: "rahim@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=1", city: "Dhaka", status: "active", joinedAt: "2024-01-10" },
  { id: "u2", name: "Sultana Begum", email: "sultana@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=2", city: "Chittagong", status: "active", joinedAt: "2024-02-14" },
  { id: "u3", name: "Karim Hossain", email: "karim@example.com", role: "admin", avatar: "https://i.pravatar.cc/40?img=3", city: "Sylhet", status: "active", joinedAt: "2024-01-05" },
  { id: "u4", name: "Nusrat Jahan", email: "nusrat@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=4", city: "Rajshahi", status: "banned", joinedAt: "2024-03-20" },
  { id: "u5", name: "Farhan Ahmed", email: "farhan@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=5", city: "Dhaka", status: "active", joinedAt: "2024-04-01" },
  { id: "u6", name: "Mitu Akter", email: "mitu@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=6", city: "Khulna", status: "active", joinedAt: "2024-04-15" },
  { id: "u7", name: "Sabbir Rahman", email: "sabbir@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=7", city: "Dhaka", status: "active", joinedAt: "2024-05-02" },
  { id: "u8", name: "Ripa Khatun", email: "ripa@example.com", role: "user", avatar: "https://i.pravatar.cc/40?img=8", city: "Barisal", status: "banned", joinedAt: "2024-05-18" },
]
...
const barData = [
  ...
  { month: "Apr", listings: 28 },
  { month: "May", listings: 24 },
  { month: "Jun", listings: 33 },
  { month: "Jul", listings: 29 },
  { month: "Aug", listings: 38 },
]
...
const Sidebar = ({ activePage, setActivePage, setSidebarOpen, onLogout }: SidebarProps) => (
  <div className="flex flex-col h-full">
    ...
    >
      ...
      <span className="ml-1 text-xs bg-amber-100 dark:bg-amber-900/30 text-amber-600 px-1.5 py-0.5 rounded font-medium">
        Admin
      </span>
    </Link>
          ...
          {dropdownOpen && (
            <div className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl shadow-xl z-50 py-2 overflow-hidden">
              ...
              <button
                ...
                className="w-full flex items-center gap-2 px-4 py-2 text-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700"
              >
...
const OverviewPage = () => {
  const stats = [
    { label: "Total Users", value: "1,248", icon: <Users size={20} />, color: "text-blue-800 dark:text-blue-400", bg: "bg-blue-50 dark:bg-blue-900/20" },
    { label: "Total Listings", value: properties.length.toString(), icon: <Building2 size={20} />, color: "text-amber-600 dark:text-amber-400", bg: "bg-amber-50 dark:bg-amber-900/20" },
    { label: "Total Bookings", value: "312", icon: <BookOpen size={20} />, color: "text-green-600 dark:text-green-400", bg: "bg-green-50 dark:bg-green-900/20" },
    { label: "Total Revenue", value: "৳35,00,000", icon: <DollarSign size={20} />, color: "text-purple-600 dark:text-purple-400", bg: "bg-purple-50 dark:bg-purple-900/20" },
  ]
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <select
          ...
          className="px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-800 dark:text-white text-sm outline-none focus:border-blue-800"
        >
        ...
        <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl flex items-center justify-between">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="flex items-center gap-1 px-3 py-1.5 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-lg text-xs"
            >
              <X size={14} /> Cancel
            </button>
            <button
              onClick={() => setDeleteId(null)}
              className="flex items-center gap-1 px-3 py-1.5 bg-red-600 text-white rounded-lg text-xs"
            >
                ...
                <tr key={p.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button className="p-1.5 bg-blue-50 dark:bg-blue-900/20 text-blue-800 dark:text-blue-400 rounded-lg hover:bg-blue-100 transition-colors">
                        <Edit2 size={14} />
                      </button>
                      <button
        ...
        <div className="px-4 py-3 border-t border-gray-100 dark:border-gray-700 flex items-center justify-between">
          ...
          <div className="flex items-center gap-1">
            <button
              ...
              className="p-1.5 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 disabled:opacity-40 text-gray-600 dark:text-gray-300"
            >
              <ChevronLeft size={16} />
            </button>
            ...
            <tbody className="divide-y divide-gray-100 dark:divide-gray-700">
              {paginated.map(u => (
                <tr key={u.id} className="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                  ...
                  <td className="px-4 py-3 text-gray-500 dark:text-gray-400 text-xs">{u.joinedAt}</td>
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <button
          ...
          <div className="flex items-center gap-1">
            ...
            {Array.from({ length: totalPages }, (_, i) => i + 1).map(page => (
              <button key={page} onClick={() => setCurrentPage(page)}
                className={`w-7 h-7 rounded-lg text-xs font-medium transition-colors ${currentPage === page ? "bg-blue-800 text-white" : "hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-600 dark:text-gray-300"}`}>
                {page}
              </button>
            ))}
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <span className="text-xs bg-amber-50 dark:bg-amber-900/30 text-amber-600 px-2 py-0.5 rounded-lg capitalize">
              {user?.role}
            </span>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 space-y-5">
        ...
        <div className="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-900 rounded-xl">
          ...
          <button
            onClick={toggleTheme}
            className={`relative w-11 h-6 rounded-full transition-colors ${isDark ? "bg-blue-800" : "bg-gray-300"}`}
          >
