...
const milestones = [
  ...
  {
    year: "2018",
    event: "Expanded to Chittagong and Sylhet. Reached 1,000 listings.",
  },
  {
    year: "2020",
    event: "Launched mobile-friendly platform. 5,000+ active listings.",
  },
  {
    year: "2022",
    event: "Introduced verified owner badges and tour booking system.",
  },
  {
    year: "2024",
    event: "Launched AI-powered property search and recommendation engine.",
  },
];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <section className="relative bg-blue-800 dark:bg-blue-900 text-white py-24 px-4 overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1560518883-ce09059eeffa?w=1400')",
        ...
        <div className="relative max-w-4xl mx-auto text-center">
          ...
          <p className="text-blue-100 text-lg max-w-2xl mx-auto leading-relaxed">
            NestFinder was built with one goal — to make finding, renting, and
            buying property in Bangladesh simple, transparent, and trustworthy
            for everyone.
          </p>
        </div>
      </section>
      ...
      <section className="py-14 px-4 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((s) => (
            ...
            >
              <div className="flex justify-center mb-3 text-blue-800 dark:text-blue-400">
                {s.icon}
              </div>
              <div className="text-3xl font-bold text-blue-800 dark:text-blue-400 mb-1">
                {s.value}
              </div>
        ...
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              In Bangladesh, finding a reliable rental or property to buy has
              always been difficult — full of middlemen, inflated prices, and
              unverified listings. NestFinder was created to fix that.
            </p>
            <p className="text-gray-600 dark:text-gray-300 mb-6 leading-relaxed">
              We give property owners a direct platform to list their
              properties, and give seekers the tools to search, compare, and
              connect — all without unnecessary friction.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {values.map((v) => (
              <div
                key={v.title}
                className="bg-white dark:bg-gray-800 rounded-2xl p-6 border border-gray-200 dark:border-gray-700 flex gap-4"
              >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {team.map((m) => (
              ...
              >
                ...
                <div className="text-xs text-blue-800 dark:text-blue-400 font-medium mb-2">
                  {m.role}
                </div>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="bg-blue-800 dark:bg-blue-900 rounded-3xl p-10 text-white text-center">
            ...
            <p className="text-xl font-medium leading-relaxed mb-6">
              "I found my 3-bedroom apartment in Mirpur within 3 days of
              searching on NestFinder. The owner's contact was real, the photos
              matched perfectly, and there were zero hidden costs."
            </p>
      ...
      <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-300 mb-8 max-w-xl mx-auto">
          Browse thousands of verified properties across Bangladesh —
          apartments, houses, commercial spaces, and land.
        </p>
